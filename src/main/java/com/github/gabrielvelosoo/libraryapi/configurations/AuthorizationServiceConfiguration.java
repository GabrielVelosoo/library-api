...
import com.github.gabrielvelosoo.libraryapi.security.CustomAuthentication;
...
public class AuthorizationServiceConfiguration {
    ...
    @Bean
    public JWKSource<SecurityContext> generateJWKToken() throws Exception {
        RSAKey rsaKey = generateRSAKeyPair();
        JWKSet jwkSet = new JWKSet(rsaKey);
        return new ImmutableJWKSet<>(jwkSet);
    }

    private RSAKey generateRSAKeyPair() throws Exception {
